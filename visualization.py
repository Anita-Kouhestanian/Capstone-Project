...
# the following code visualizes the face detection Haar cascade classifier(some of its kernels)
# and visualizes the rectangular features
if __name__ == "__main__":
    ...
    for stage in stages_list:
        ...
        # it will will generate 25 pictures because of 25 stages
